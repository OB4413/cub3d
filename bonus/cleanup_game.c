...
/*   Updated: 2025/08/26 10:45:46 by ynadime          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	destroy_images(t_game *game)
{
	...
	{
		if (game->ak_imag)
			ft_destroy_image(game->mlx, game->ak_imag[i]);
		if (game->mg_imag)
			ft_destroy_image(game->mlx, game->mg_imag[i]);
		if (game->pst_imag)
			ft_destroy_image(game->mlx, game->pst_imag[i]);
		i++;
	}
	ft_destroy_image(game->mlx, game->imag);
	ft_destroy_image(game->mlx, game->imag_v);
	ft_destroy_image(game->mlx, game->door_imag);
